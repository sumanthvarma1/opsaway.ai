...
const Tech: NextPage = () => {
  return <div className="relative bg-gray w-full h-[700px] left-[70px] top-[40px]" >
    ...
    <div className="relative  w-61 h-[73px] top-[300px] left-[920px] text-white">Browse all the projects</div>
    </div>
};
